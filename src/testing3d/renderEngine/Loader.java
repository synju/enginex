...
import testing3d.textures.TextureData;
...
public class Loader {
	...
	public int loadTexture(String file) {
		...
		try {
			texture = TextureLoader.getTexture("PNG", new FileInputStream("src/testing3d/res/" + file + ".png"));
	...
	public int loadCubeMap(String[] textureFiles) {
		...
		for(int i = 0; i < textureFiles.length; i++) {
			TextureData data = decodeTextureFile("src/testing3d/res/skybox/" + textureFiles[i] + ".png");
