...
public class Rocket extends GameObject {
	...
	public Rocket(EngineX game, int x, int y, int maxMoves, int speed, int[] dna) {
		super(game);
		this.dna = dna;
		init(x, y, maxMoves, speed);
	}
	...
	void calcFitness() {
		float d = Util.getDistance(new Vector2((int)x, (int)y), new Vector2(getState().target.x, getState().target.y));
